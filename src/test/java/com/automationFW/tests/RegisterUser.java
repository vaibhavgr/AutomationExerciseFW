...
public class RegisterUser extends BaseTest {
	...
	public void verifyUserIsAbletoRegisterWithValidCreds() {
		...
		HashMap<String,Object> validateSignupMaps = SignupLoginPageObj.validateSignup(email);
		...
		LinkedHashMap<Object, Object> accountCreationamap = SignupLoginPageObj.validateAndCreateAccountInfo(password);
